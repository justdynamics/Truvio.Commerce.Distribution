...
INSERT INTO EcomGroups (GroupId, GroupLanguageId, GroupName, GroupNavigationShowInMenu, GroupNavigationClickable) VALUES ('FIXTGRP1', 'ENU', N'Sample Group 1 — Pricing Demos', 1, 1);
INSERT INTO EcomShopGroupRelation (ShopGroupShopId, ShopGroupGroupId, ShopGroupRelationsSorting) VALUES ('SHOP1', 'FIXTGRP1', 1);
INSERT INTO EcomGroups (GroupId, GroupLanguageId, GroupName, GroupNavigationShowInMenu, GroupNavigationClickable) VALUES ('FIXTGRP2', 'ENU', N'Sample Group 2 — Plain Masters', 1, 1);
INSERT INTO EcomShopGroupRelation (ShopGroupShopId, ShopGroupGroupId, ShopGroupRelationsSorting) VALUES ('SHOP1', 'FIXTGRP2', 2);
INSERT INTO EcomGroups (GroupId, GroupLanguageId, GroupName, GroupNavigationShowInMenu, GroupNavigationClickable) VALUES ('FIXTGRP3', 'ENU', N'Sample Group 3 — Variant Demos', 1, 1);
...
INSERT INTO EcomProducts (ProductId, ProductLanguageId, ProductVariantId, ProductNumber, ProductName, ProductShortDescription, ProductPrice, ProductActive, ProductNeverOutOfStock, ProductStock, ProductType, ProductDefaultShopId, ProductCreated, ProductUpdated) VALUES ('FIXT0001', 'ENU', '', 'FIXT-0001', N'Sample Product 01 — Contract Price', N'Placeholder product. Demonstrates a buyer-scoped contract price (FIXT-PRICE-CONTRACT) and is the line item on the seeded delivered order the RMA flow returns against.', 200.00, 1, 1, 100, 0, 'SHOP1', GETDATE(), GETDATE());
...
INSERT INTO EcomProducts (ProductId, ProductLanguageId, ProductVariantId, ProductNumber, ProductName, ProductShortDescription, ProductPrice, ProductActive, ProductNeverOutOfStock, ProductStock, ProductType, ProductDefaultShopId, ProductCreated, ProductUpdated) VALUES ('FIXT0002', 'ENU', '', 'FIXT-0002', N'Sample Product 02 — Qty Tiers', N'Placeholder product. Demonstrates the quantity-break price ladder (tiers at 5, 10 and 25).', 100.00, 1, 1, 100, 0, 'SHOP1', GETDATE(), GETDATE());
...
INSERT INTO EcomProducts (ProductId, ProductLanguageId, ProductVariantId, ProductNumber, ProductName, ProductShortDescription, ProductPrice, ProductActive, ProductNeverOutOfStock, ProductStock, ProductType, ProductDefaultShopId, ProductCreated, ProductUpdated) VALUES ('FIXT0003', 'ENU', '', 'FIXT-0003', N'Sample Product 03 — Master', N'Placeholder product. Plain catalogue master with a list price and no special pricing.', 85.00, 1, 1, 100, 0, 'SHOP1', GETDATE(), GETDATE());
...
INSERT INTO EcomProducts (ProductId, ProductLanguageId, ProductVariantId, ProductNumber, ProductName, ProductShortDescription, ProductPrice, ProductActive, ProductNeverOutOfStock, ProductStock, ProductType, ProductDefaultShopId, ProductCreated, ProductUpdated) VALUES ('FIXT0004', 'ENU', '', 'FIXT-0004', N'Sample Product 04 — Master', N'Placeholder product. Plain catalogue master used to give list and grid layouts more than one card.', 95.00, 1, 1, 100, 0, 'SHOP1', GETDATE(), GETDATE());
...
INSERT INTO EcomProducts (ProductId, ProductLanguageId, ProductVariantId, ProductNumber, ProductName, ProductShortDescription, ProductPrice, ProductActive, ProductNeverOutOfStock, ProductStock, ProductType, ProductDefaultShopId, ProductCreated, ProductUpdated) VALUES ('FIXT0005', 'ENU', '', 'FIXT-0005', N'Sample Product 05 — Master', N'Placeholder product. Plain catalogue master used to fill the product list beyond a single row.', 120.00, 1, 1, 100, 0, 'SHOP1', GETDATE(), GETDATE());
...
INSERT INTO EcomProducts (ProductId, ProductLanguageId, ProductVariantId, ProductNumber, ProductName, ProductShortDescription, ProductPrice, ProductActive, ProductNeverOutOfStock, ProductStock, ProductType, ProductDefaultShopId, ProductCreated, ProductUpdated) VALUES ('FIXT0006', 'ENU', '', 'FIXT-0006', N'Sample Product 06 — Master', N'Placeholder product. Plain catalogue master in the second group, so group navigation has something to switch between.', 45.00, 1, 1, 100, 0, 'SHOP1', GETDATE(), GETDATE());
...
INSERT INTO EcomProducts (ProductId, ProductLanguageId, ProductVariantId, ProductNumber, ProductName, ProductShortDescription, ProductPrice, ProductActive, ProductNeverOutOfStock, ProductStock, ProductType, ProductDefaultShopId, ProductCreated, ProductUpdated) VALUES ('FIXT0009', 'ENU', '', 'FIXT-0009', N'Sample Product 09 — Master', N'Placeholder product. Plain catalogue master used by the search and facet probes.', 40.00, 1, 1, 100, 0, 'SHOP1', GETDATE(), GETDATE());
...
INSERT INTO EcomProducts (ProductId, ProductLanguageId, ProductVariantId, ProductNumber, ProductName, ProductShortDescription, ProductPrice, ProductActive, ProductNeverOutOfStock, ProductStock, ProductType, ProductDefaultShopId, ProductCreated, ProductUpdated) VALUES ('FIXT0010', 'ENU', '', 'FIXT-0010', N'Sample Product 10 — Master', N'Placeholder product. Plain catalogue master in the third group, the lowest price band.', 25.00, 1, 1, 100, 0, 'SHOP1', GETDATE(), GETDATE());
...
INSERT INTO EcomProducts (ProductId, ProductLanguageId, ProductVariantId, ProductNumber, ProductName, ProductShortDescription, ProductPrice, ProductActive, ProductNeverOutOfStock, ProductStock, ProductType, ProductDefaultShopId, ProductCreated, ProductUpdated) VALUES ('FIXT0011', 'ENU', '', 'FIXT-0011', N'Sample Product 11 — Master', N'Placeholder product. Plain catalogue master used to demonstrate a low-value repeat-order line.', 12.00, 1, 1, 100, 0, 'SHOP1', GETDATE(), GETDATE());
...
INSERT INTO EcomProducts (ProductId, ProductLanguageId, ProductVariantId, ProductNumber, ProductName, ProductShortDescription, ProductPrice, ProductActive, ProductNeverOutOfStock, ProductStock, ProductType, ProductDefaultShopId, ProductCreated, ProductUpdated) VALUES ('FIXT0012', 'ENU', '', 'FIXT-0012', N'Sample Product 12 — Master', N'Placeholder product. Plain catalogue master used to demonstrate a low-value repeat-order line.', 18.00, 1, 1, 100, 0, 'SHOP1', GETDATE(), GETDATE());
...
INSERT INTO EcomProducts (ProductId, ProductLanguageId, ProductVariantId, ProductNumber, ProductName, ProductShortDescription, ProductPrice, ProductActive, ProductNeverOutOfStock, ProductStock, ProductType, ProductDefaultShopId, ProductCreated, ProductUpdated) VALUES ('FIXT0013', 'ENU', '', 'FIXT-0013', N'Sample Product 13 — Size Variants', N'Placeholder product. Demonstrates the Size variant axis: this master expands into Small, Medium and Large variant rows.', 22.00, 1, 1, 100, 0, 'SHOP1', GETDATE(), GETDATE());
...
INSERT INTO EcomProducts (ProductId, ProductLanguageId, ProductVariantId, ProductNumber, ProductName, ProductShortDescription, ProductPrice, ProductActive, ProductNeverOutOfStock, ProductStock, ProductType, ProductDefaultShopId, ProductCreated, ProductUpdated) VALUES ('FIXT0014', 'ENU', '', 'FIXT-0014', N'Sample Product 14 — Size Variants', N'Placeholder product. Second master on the Size variant axis, so variant behaviour is visible on more than one product.', 75.00, 1, 1, 100, 0, 'SHOP1', GETDATE(), GETDATE());
...
VALUES ('FIXT-ORDER-RMA1-1', 'FIXT-ORDER-RMA1', 'FIXT0001', 'FIXT-0001', N'Sample Product 01 — Contract Price', 1, 200.00, 200.00, '0', DATEADD(day, -30, GETDATE()));
