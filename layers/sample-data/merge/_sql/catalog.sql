...
--   Reserved KEYS stay FIXT*-prefixed; the DISPLAY names and short descriptions are
--   neutral demo-catalogue values (never 'Fixture ...'), because on any edition with
--   sampleData: true this is the catalogue a prospect actually sees.
...
INSERT INTO EcomGroups (GroupId, GroupLanguageId, GroupName, GroupNavigationShowInMenu, GroupNavigationClickable) VALUES ('FIXTGRP1', 'ENU', 'Drive Components', 1, 1);
INSERT INTO EcomShopGroupRelation (ShopGroupShopId, ShopGroupGroupId, ShopGroupRelationsSorting) VALUES ('SHOP1', 'FIXTGRP1', 1);
INSERT INTO EcomGroups (GroupId, GroupLanguageId, GroupName, GroupNavigationShowInMenu, GroupNavigationClickable) VALUES ('FIXTGRP2', 'ENU', 'Workshop Equipment', 1, 1);
INSERT INTO EcomShopGroupRelation (ShopGroupShopId, ShopGroupGroupId, ShopGroupRelationsSorting) VALUES ('SHOP1', 'FIXTGRP2', 2);
INSERT INTO EcomGroups (GroupId, GroupLanguageId, GroupName, GroupNavigationShowInMenu, GroupNavigationClickable) VALUES ('FIXTGRP3', 'ENU', 'Consumables', 1, 1);
...
INSERT INTO EcomProducts (ProductId, ProductLanguageId, ProductVariantId, ProductNumber, ProductName, ProductShortDescription, ProductPrice, ProductActive, ProductNeverOutOfStock, ProductStock, ProductType, ProductDefaultShopId, ProductCreated, ProductUpdated) VALUES ('FIXT0001', 'ENU', '', 'FIXT-0001', 'Sealed Bearing Set', N'Sealed cartridge bearings for hub and bottom-bracket service, supplied as a matched pair.', 200.00, 1, 1, 100, 0, 'SHOP1', GETDATE(), GETDATE());
...
INSERT INTO EcomProducts (ProductId, ProductLanguageId, ProductVariantId, ProductNumber, ProductName, ProductShortDescription, ProductPrice, ProductActive, ProductNeverOutOfStock, ProductStock, ProductType, ProductDefaultShopId, ProductCreated, ProductUpdated) VALUES ('FIXT0002', 'ENU', '', 'FIXT-0002', 'Chain Drive Kit', N'Chain, connecting link and guide roller, pre-matched for 11-speed drivetrains.', 100.00, 1, 1, 100, 0, 'SHOP1', GETDATE(), GETDATE());
...
INSERT INTO EcomProducts (ProductId, ProductLanguageId, ProductVariantId, ProductNumber, ProductName, ProductShortDescription, ProductPrice, ProductActive, ProductNeverOutOfStock, ProductStock, ProductType, ProductDefaultShopId, ProductCreated, ProductUpdated) VALUES ('FIXT0003', 'ENU', '', 'FIXT-0003', 'Freewheel Cassette', N'Hardened-steel cassette on an alloy carrier, 11-34T.', 85.00, 1, 1, 100, 0, 'SHOP1', GETDATE(), GETDATE());
...
INSERT INTO EcomProducts (ProductId, ProductLanguageId, ProductVariantId, ProductNumber, ProductName, ProductShortDescription, ProductPrice, ProductActive, ProductNeverOutOfStock, ProductStock, ProductType, ProductDefaultShopId, ProductCreated, ProductUpdated) VALUES ('FIXT0004', 'ENU', '', 'FIXT-0004', 'Crank Assembly', N'Forged alloy crank arms with a sealed spindle, 170mm.', 95.00, 1, 1, 100, 0, 'SHOP1', GETDATE(), GETDATE());
...
INSERT INTO EcomProducts (ProductId, ProductLanguageId, ProductVariantId, ProductNumber, ProductName, ProductShortDescription, ProductPrice, ProductActive, ProductNeverOutOfStock, ProductStock, ProductType, ProductDefaultShopId, ProductCreated, ProductUpdated) VALUES ('FIXT0005', 'ENU', '', 'FIXT-0005', 'Hub Motor Unit', N'Sealed rear hub motor, 250W, with an integrated torque sensor.', 120.00, 1, 1, 100, 0, 'SHOP1', GETDATE(), GETDATE());
...
INSERT INTO EcomProducts (ProductId, ProductLanguageId, ProductVariantId, ProductNumber, ProductName, ProductShortDescription, ProductPrice, ProductActive, ProductNeverOutOfStock, ProductStock, ProductType, ProductDefaultShopId, ProductCreated, ProductUpdated) VALUES ('FIXT0006', 'ENU', '', 'FIXT-0006', 'Torque Wrench', N'Click-type torque wrench, 2-24Nm, with a nine-bit workshop set.', 45.00, 1, 1, 100, 0, 'SHOP1', GETDATE(), GETDATE());
...
INSERT INTO EcomProducts (ProductId, ProductLanguageId, ProductVariantId, ProductNumber, ProductName, ProductShortDescription, ProductPrice, ProductActive, ProductNeverOutOfStock, ProductStock, ProductType, ProductDefaultShopId, ProductCreated, ProductUpdated) VALUES ('FIXT0007', 'ENU', '', 'FIXT-0007', 'Hydraulic Bleed Kit', N'Complete bleed kit with syringes, adapters and mineral oil.', 180.00, 1, 1, 100, 0, 'SHOP1', GETDATE(), GETDATE());
...
INSERT INTO EcomProducts (ProductId, ProductLanguageId, ProductVariantId, ProductNumber, ProductName, ProductShortDescription, ProductPrice, ProductActive, ProductNeverOutOfStock, ProductStock, ProductType, ProductDefaultShopId, ProductCreated, ProductUpdated) VALUES ('FIXT0008', 'ENU', '', 'FIXT-0008', 'Workshop Repair Stand', N'Height-adjustable repair stand with a quick-release clamp, folds flat.', 60.00, 1, 1, 100, 0, 'SHOP1', GETDATE(), GETDATE());
...
INSERT INTO EcomProducts (ProductId, ProductLanguageId, ProductVariantId, ProductNumber, ProductName, ProductShortDescription, ProductPrice, ProductActive, ProductNeverOutOfStock, ProductStock, ProductType, ProductDefaultShopId, ProductCreated, ProductUpdated) VALUES ('FIXT0009', 'ENU', '', 'FIXT-0009', 'Digital Tension Gauge', N'Digital spoke-tension gauge with a calibration reference block.', 40.00, 1, 1, 100, 0, 'SHOP1', GETDATE(), GETDATE());
...
INSERT INTO EcomProducts (ProductId, ProductLanguageId, ProductVariantId, ProductNumber, ProductName, ProductShortDescription, ProductPrice, ProductActive, ProductNeverOutOfStock, ProductStock, ProductType, ProductDefaultShopId, ProductCreated, ProductUpdated) VALUES ('FIXT0010', 'ENU', '', 'FIXT-0010', 'Cable Housing Set', N'Pre-cut outer housing, ferrules and end caps for a full cable replacement.', 25.00, 1, 1, 100, 0, 'SHOP1', GETDATE(), GETDATE());
...
INSERT INTO EcomProducts (ProductId, ProductLanguageId, ProductVariantId, ProductNumber, ProductName, ProductShortDescription, ProductPrice, ProductActive, ProductNeverOutOfStock, ProductStock, ProductType, ProductDefaultShopId, ProductCreated, ProductUpdated) VALUES ('FIXT0011', 'ENU', '', 'FIXT-0011', 'Brake Pad Pack', N'Organic disc brake pads, ten pairs, with retaining pins.', 12.00, 1, 1, 100, 0, 'SHOP1', GETDATE(), GETDATE());
...
INSERT INTO EcomProducts (ProductId, ProductLanguageId, ProductVariantId, ProductNumber, ProductName, ProductShortDescription, ProductPrice, ProductActive, ProductNeverOutOfStock, ProductStock, ProductType, ProductDefaultShopId, ProductCreated, ProductUpdated) VALUES ('FIXT0012', 'ENU', '', 'FIXT-0012', 'Degreaser Concentrate', N'Biodegradable drivetrain degreaser concentrate, dilutes 1:10.', 18.00, 1, 1, 100, 0, 'SHOP1', GETDATE(), GETDATE());
...
INSERT INTO EcomProducts (ProductId, ProductLanguageId, ProductVariantId, ProductNumber, ProductName, ProductShortDescription, ProductPrice, ProductActive, ProductNeverOutOfStock, ProductStock, ProductType, ProductDefaultShopId, ProductCreated, ProductUpdated) VALUES ('FIXT0013', 'ENU', '', 'FIXT-0013', 'Workshop Glove', N'Cut-resistant workshop glove with a reinforced palm. Sized S/M/L.', 22.00, 1, 1, 100, 0, 'SHOP1', GETDATE(), GETDATE());
...
INSERT INTO EcomProducts (ProductId, ProductLanguageId, ProductVariantId, ProductNumber, ProductName, ProductShortDescription, ProductPrice, ProductActive, ProductNeverOutOfStock, ProductStock, ProductType, ProductDefaultShopId, ProductCreated, ProductUpdated) VALUES ('FIXT0014', 'ENU', '', 'FIXT-0014', 'Drive Belt', N'Carbon-reinforced belt drive for belt-specific frames. Sized S/M/L.', 75.00, 1, 1, 100, 0, 'SHOP1', GETDATE(), GETDATE());
...
VALUES ('FIXT-ORDER-RMA1-1', 'FIXT-ORDER-RMA1', 'FIXT0001', 'FIXT-0001', 'Sealed Bearing Set', 1, 200.00, 200.00, '0', DATEADD(day, -30, GETDATE()));
