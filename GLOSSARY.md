...
| **catalog** | The demo product catalog layer (`catalog-fixture`) an edition adds when it needs products. |
...
Layer references are `<name>@<semver>` (e.g. `base@2.3.0`, `catalog-fixture@1.0.0`). The
